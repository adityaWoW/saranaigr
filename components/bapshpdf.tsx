      ...
      <div ref={ref} className="bg-white p-6 rounded-lg border">
        ...
        <div className="w-full flex flex-col items-center">
          <p className="text-left">
            Sehubungan dengan sudah lewatnya periode waktu 14 hari sejak terjadi
            selisih serah terima sarana Idm. dengan rincian sbb.
          </p>
          ...
          <table className="w-fit text-left">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  : {tableData[0].nik_pengirim} / {tableData[0].nama_pengirim}
                </td>
              </tr>
              <tr>
                <td className="font-semibold pr-32">NIK / Nama Penerima</td>
                <td>
                  : {tableData[0].nik_penerima} / {tableData[0].nama_penerima}
                </td>
              </tr>
              <tr>
                <td className="font-semibold pr-32 align-top">
                  Nomor Seri Sarana yang Selisih
                </td>
                <td className="pr-2 align-top">
                  : - Bronjong:{" "}
                  {bronjong.length > 0 ? bronjong.join(", ") : "-"}
                </td>
              </tr>
              <tr>
                ...
                <td className="pr-2 align-top">
                  : - Container:{" "}
                  {container.length > 0 ? container.join(", ") : "-"}
                </td>
              </tr>
              <tr>
                <td className="font-semibold pr-32 align-top"></td>
                <td className="pr-2 align-top">
                  : - Dolly: {dolly.length > 0 ? dolly.join(", ") : "-"}
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="w-full flex flex-col items-center">
            <p className="text-left">
              Maka atas selisih tsb. di atas akan dibebankan ke personil di
              bawah ini selaku penanggungjawab serah terima sarana Idm. tsb :
            </p>
            <br />
            <table className="w-fit text-left">
              <tbody>
                <tr>
                  <td className="font-semibold pr-16 align-top">
